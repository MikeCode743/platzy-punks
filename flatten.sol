...
// File contracts/PlatzyPunks.sol
...
contract PlatzyPunks is ERC721, ERC721Enumerable, PunkDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("MiguelToken", "MTKN") {
